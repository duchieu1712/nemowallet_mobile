...
export default function ListTransactionNFT() {
  const navigation = useNavigation();

  const _services = cf_services.filter((e) => e.isActiveMarketplace);
  const [transactions, setTransactions] = useState<any>(null);
  const [gameSelected, setGameSelected] = useState(_services[0]);
        ...
        <View style={{ width: "100%", paddingBottom: 80 }}>
          ...
          >
            ...
            <SelectDropdown
              ...
              buttonTextAfterSelection={(_) => gameSelected.serviceName as any}
              ...
              renderCustomizedButtonChild={(selected) => (
                ...
                >
                  <Image source={selected?.logoGame} style={styles.icon} />
